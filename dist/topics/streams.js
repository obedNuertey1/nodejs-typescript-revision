...
export default () => {
    ...
    //Writing to a Stream
    console.log("\n\n*********** Writing to a Stream **************");
    let data2 = Buffer.from("Simply Easy Learning");
    //Create a writable stream
    ...
    console.log("Program Ended");
    console.log("\n\n************ Piping the Streams **************");
    const readerStream2 = fs.createReadStream('input.txt');
    //Create a writable stream
    ...
    //Decompress the file input.txt.gz to input.txt
    console.log("\n************ Decompress the file input.txt.gz to input.txt **********");
    const createReadStream = fs.createReadStream('input.txt.gz');
    ...
    }).pipe(gunzipStream).on('error', (error) => {
